...
3. Migrate to **hybrid** mode (classical + ML-KEM/ML-DSA via BC), since hybrid is the realistic 2026 enterprise target, per IETF/industry practice: key establishment → X25519+ML-KEM-768 pattern; signatures → dual-sign where format permits, else ML-DSA-65.
