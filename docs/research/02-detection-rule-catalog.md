...
|---|---|---|---|
| RSA-2048 | ~294 B (SPKI) | 256 B sig | n/a |
| ECDSA P-256 | 65 B raw / ~91 B SPKI | 64 B raw / 70–72 B DER sig | n/a |
| Ed25519 | 32 B | 64 B sig | n/a |
| X25519 | 32 B | n/a | 32 B |
| **ML-KEM-768** | **1,184 B** | **1,088 B ct** | 32 B |
| ML-KEM-512 / 1024 | 800 / 1,568 B | 768 / 1,568 B ct | 32 B |
| **ML-DSA-65** | **1,952 B** | **3,309 B sig** | n/a |
| ML-DSA-44 / 87 | 1,312 / 2,592 B | 2,420 / 4,627 B sig | n/a |
| SLH-DSA (all sets) | 32–64 B | **7,856–49,856 B sig** | n/a |
...
- Literal-only in wave 1; JCA names are **case-insensitive**, so match accordingly.
...
| JOSE/JWT (RFC 7518 `alg`) | `RS256/384/512`, `ES256/384/512`, `ES256K`, `PS256/384/512`, `EdDSA` (jjwt, auth0 java-jwt, nimbus-jose), while `HS*` is fine |
